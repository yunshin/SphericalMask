...
def get_sph_gt(inst_points, inst_points_center, rays_width, rays_height, angles_ref, centering=False, chk_iou=True, all_points=None, inst_loc=None):
...
def get_instance_info_dyco_ray(coords_float, instance_labels, semantic_labels, rays_width, rays_height, angles_ref, label_shift=2, is_analyze=False):
    instance_pointnum = []
    instance_cls = []
    instance_box = []
    instance_sphere = []
...
def get_subsample_gt_rays(
    instance_labels, subsample_idxs, instance_cls, instance_box, rays_labels, subsample_batch_offsets, batch_size, ignore_label=-100
):
    subsample_inst_mask_arr = []
