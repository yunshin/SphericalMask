    ...
    def forward_test(
        ...
        **kwargs
        ...
        for i in range(len(n_sample_arr)):
            ...
            masks_gt, masks_angles_gt = get_mask_from_polar_single(voxel_coords_float, box_preds, self.rays_width, self.rays_height, is_angular=True, pointwise_angular=voxel_angular_offset )
            
            mask_pure_ray.append(masks_gt)
            mask_angles.append(masks_angles_gt)
