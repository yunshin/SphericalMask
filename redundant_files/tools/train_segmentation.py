...
def main():
    ...
    optimizer = build_optimizer_tune(model, cfg.optimizer)
    ...
    epoch = 0
    #ap = validate(epoch, model, optimizer, val_loader, cfg, logger, writer, type=1)
    #pdb.set_trace()
    #validate(epoch, model, optimizer, val_loader, cfg, logger, writer, type=3)
