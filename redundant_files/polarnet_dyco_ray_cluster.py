...
class PolarNet_Dyco_Ray_Cluster(nn.Module):
    ...
    def get_output_new(self, dc_coords_float, mask_logits, rays_labels, query_locs, dc_mask_features_permute, mask_feats, proto_coff, gt_masks, ray_preds):
        ...
        rays_from_mask[:,:-3] = rays_from_mask[:,:-3] + ray_preds
    ...
    def forward_test(
        ...
        **kwargs
        ...
        if vis_save:
            ...
            '''
            ret['feats_np'] = feats_np; ret['instance_cls_np']=instance_cls_np;ret['rays_labels_np']=rays_labels_np
            ret['semantic_labels_np']=semantic_labels_np;ret['instance_labels_np']=instance_labels_np;ret['coords_float_np']=coords_float_np
            ret['instance_sphere_np']=instance_sphere_np;ret['real_points'] = np.array(real_points)
        ...
        for i in range(len(n_sample_arr)):
            ...
            if type == 0:
                ...
                masks_proto = self.get_output_new(dc_coords_float, mask_logits, rays_labels, query_locs, dc_mask_features_permute, mask_feats, proto_coff, gt_masks, ray_preds)
    ...
    def get_instance(
        ...
        # NOTE NMS
        masks_final, cls_final, scores_final, boxes_final, _idxs = nms(
