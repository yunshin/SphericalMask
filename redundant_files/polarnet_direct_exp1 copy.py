...
class PolarNet_Direct_EXP1(nn.Module):
    ...
    def forward_train(
        ...
        **kwargs
        ...
        instance_cls, instance_box, instance_sphere, centroid_offset_labels, pointwise_angular_labels, corners_offset_labels, corners_offset_labels_sph, rays_labels = get_instance_info_polarnet_exp1(
    ...
    def forward_test(
        ...
        **kwargs
        ...
        if self.is_mask == False:
            ...
            if self.is_analyze:
                instance_cls, instance_box, instance_sphere, centroid_offset_labels, pointwise_angular_labels, corners_offset_labels, rays_gt_list = get_instance_info_polarnet_exp1(
            ...
            instance_cls, instance_box, instance_sphere, centroid_offset_labels, pointwise_angular_labels, corners_offset_labels, corners_offset_labels_sph, corners_offset_labels = get_instance_info_polarnet_exp1(
                voxel_coords_float, voxel_instance_labels, voxel_semantic_labels, self.rays_width, self.rays_height, self.angles_ref, label_shift=self.label_shift
            )
