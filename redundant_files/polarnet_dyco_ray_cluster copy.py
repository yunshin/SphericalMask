...
class PolarNet_Dyco_Ray_Cluster(nn.Module):
    ...
    def forward_train(
        ...
        **kwargs
        ...
        if self.use_spp_pool:
            ...
            dc_inst_mask_arr, _ = get_spp_gt_rays_cluster(
        ...
        cls_logits, mask_logits, mask_ray_logits, conf_logits, box_preds, angular_pred, rays_pred = self.forward_head(
    ...
    def forward_test(
        ...
        **kwargs
        ...
        for i in range(len(n_sample_arr)):
            ...
            cls_logits, mask_logits, mask_ray_logits, conf_logits, box_preds, angular_pred, rays_pred = forward_head_outputs
            ...
            if type == 0: 
                ...
                masks_ray_ = get_mask_from_polar_single2(dc_coords_float[None,:,:].repeat(len(angular_pred),1,1), ray_box_preds, angular_pred, self.rays_width, self.rays_height, 
                ...
                #angular_mask = angular_pred > 0
                #exclude_pixel = torch.where(angular_mask)
                
                #masks_ray_[exclude_pixel[0],exclude_pixel[1]] = 0
                #masks_ray_[masks_ray_==0] = -100
            elif type == 2:
    ...
    def forward_head(
        ...
        if inference:
            return cls_logits[0], mask_logits[0], mask_ray_logits[0], conf_logits[0], queries_box_preds[0], angular_preds[0], rays_pred[0]
        return cls_logits, mask_logits, mask_ray_logits, conf_logits, queries_box_preds, angular_preds, rays_pred
