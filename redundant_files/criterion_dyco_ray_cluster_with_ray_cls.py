...
class Criterion_Dyco_Ray_Cluster_with_ray_CLS(nn.Module):
    def __init__(
        self,
        semantic_classes=20,
        instance_classes=18,
        ...
        super(Criterion_Dyco_Ray_Cluster_with_ray_CLS, self).__init__()
    ...
    def single_layer_loss(
        ...
        for b in range(batch_size):
            ...
            ray_inside_mask_logits_b = ray_inside_mask_logits[b]
            ray_cls_b = ray_cls_logits[b]

            
            pred_inds, cls_label, inst_label, box_label, ray_label, ray_inside_mask_labels_b = row_indices[b], cls_labels[b], inst_labels[b], box_labels[b], ray_labels[b], ray_inside_mask_labels[b]
            ...
            ray_inside_mask_logits_b = ray_inside_mask_logits_b[pred_inds]
            ...
            if is_mask:
                ...
                bce_inside_loss = F.binary_cross_entropy_with_logits(ray_inside_mask_logits_b, ray_inside_mask_labels_b.reshape(len(ray_inside_mask_labels_b),-1), reduction="none")
                bce_inside_loss = bce_inside_loss.mean(1).sum() / (num_gt_batch + 1e-6)
                loss_dict["bce_loss_inside"] = loss_dict["bce_loss_inside"] + bce_inside_loss
                
                loss_dict["dice_loss_inside"] = loss_dict["dice_loss_inside"] + compute_dice_loss(
                    ray_inside_mask_logits_b, ray_inside_mask_labels_b.reshape(len(ray_inside_mask_labels_b),-1), num_gt_batch
                )
    ...
    def forward(self, batch_inputs, model_outputs, is_mask=True):
        ...
        ray_inside_mask_label = batch_inputs['ray_mask_label']
        ...
        ray_inside_mask_pred = model_outputs['ray_inside_mask']
        ...
        gt_dict, aux_gt_dict, matching_cost = self.matcher.forward_dup(
            ...
            ray_inside_label=ray_inside_mask_label,
            dup_gt=4,
        )
        ...
        ray_inside_labels = gt_dict['ray_inside_labels']
        ...
        aux_ray_inside_labels = aux_gt_dict['ray_inside_labels']
